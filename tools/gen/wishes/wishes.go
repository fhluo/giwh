...
func init() {
	...
	for key := range Wishes {
		slices.SortFunc(Wishes[key], func(a, b i18n.WishType) int {
			return cmp.Compare(a.Key, b.Key)
		})
	}

	for key := range SharedWishes {
		slices.SortFunc(SharedWishes[key], func(a, b i18n.WishType) int {
			return cmp.Compare(a.Key, b.Key)
		})
	}
}
...
func NewCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			slices.SortStableFunc(types, func(a, b i18n.WishType) int {
				return cmp.Compare(a.Key, b.Key)
			})
